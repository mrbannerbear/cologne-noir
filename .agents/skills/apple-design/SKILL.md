---
name: apple-design
description: Apple's approach to interface design and fluid, physical motion, translated for the web. Use when building or reviewing gesture-driven UI, spring animations, drag/swipe/sheet interactions, momentum and interruptible transitions, translucent materials and depth, typography (optical sizing, tracking, leading), reduced-motion, or the design foundations behind Apple-style interfaces (the eight principles of great design — purpose, agency, responsibility, familiarity, flexibility, simplicity, craft, delight — and the tactical rules of feedback, wayfinding, and grouping).
---
...
The whole guide sits on one foundation: Apple's eight principles of great design (*Principles of Great Design*, WWDC 2026) — **Purpose, Agency, Responsibility, Familiarity, Flexibility, Simplicity, Craft, and Delight** (worked out in detail in §16). The interaction and craft guidance below are *how* those principles get executed in an interface.
...
These are the foundation everything in this guide serves. Apple frames design as **making something with intention** (*Principles of Great Design*, WWDC 2026): every feature asks for the user's time, attention, and trust — a budget you can't afford to waste — so deciding what *not* to build matters as much as deciding what to build. Use the eight principles as the names you reason with.

There is **no formula.** Leaning into one principle often feels like compromising on another — Simplicity against Flexibility, Agency against Responsibility. That tension is the point of design; resolve it with judgment, in context, for the people actually using your product. The four human needs — safety/predictability, understanding, achievement, joy — are what these principles serve.

### 16.1 Purpose — make it matter

Focus on what's most important to people so you build something they truly value. Every feature costs the user time, attention, and trust; spend that budget only where it pays off.

- Decide what *not* to build — omission is as important as addition.
- Use purpose as an early filter: before a sketch or a line of code, ask whether the feature has real purpose.
- Cut anything whose value doesn't justify its cost to the user.

Serves the reason the product exists. Everything else — motion, craft, content — points back to this.

### 16.2 Agency — put people in control

People feel in control when you let them do things their way. Offer choices; never stand between the person and what they're trying to do. Let them dive in and explore at their own pace instead of forcing a predetermined path. Forgiveness is what makes agency safe: people accidentally send, change, and delete things all the time.

- Make it easy to **undo** — for sending, changing, deleting.
- Confirm only genuinely destructive, irreversible actions. Interruptions exist to prevent a *big* mistake; overusing them trains people to click through.
- Prefer giving people options over blocking their goal.

Forgiveness gives people the confidence that they can always recover — capable, secure, free to explore.

### 16.3 Responsibility — act in people's best interest

Privacy is a human right. Ask for data only when needed, at the moment it's needed, with transparent context for why — never at launch, never without a reason. And anticipate harm: how could this feature be misused, who could be hurt, how do you prevent it? This is especially acute with AI, which can generate unexpected or inaccurate output.

- **Privacy:** wait for the right moment, ask only for what's necessary, be transparent about what data is for.
- **Safety:** previews, confirmations, and disclaimers help; remove a feature entirely when the risk to people outweighs its value (an allergy-aware recipe app must not suggest a harmful ingredient).
- Responsible design builds trust — the foundation of every other principle.

### 16.4 Familiarity — build on what people know

People arrive with a lifetime of experience — how the physical world works, and conventions learned from other interfaces. Lean on that to make your design intuitive. Metaphor is the tool: familiar enough to instantly click, neither so literal it's obscure nor so abstract it doesn't land. And be consistent — things that look the same should behave the same and live in the same place — so people can predict what happens next.

- Use the trash can for delete; don't assign familiar icons surprising meanings, and don't reinvent common actions.
- Consistency of behavior and placement: close is always top-left on macOS.
- Only break a familiar pattern if you can prove it's better — then test it, don't assume.

### 16.5 Flexibility — adapt to contexts, devices, abilities

People use your design in ways as unique as they are. Support the contexts they find themselves in — iPhone means quick, touch-based interactions; desktop means deep workflows and precise pointer control; add hands-free/wearable contexts where relevant. Design for the full range of abilities: age, language, experience, accessibility. When no single solution fits everyone, let people personalize.

- Design each platform's strengths, not a lowest-common-denominator.
- Be inclusive by default — you might not solve for everyone on day one, but start examining how to widen access.
- Offer personalization where layout can't fit everyone: rearrange controls, hide what people don't use.

Flexibility is an investment, but it proves you designed with each person in mind.

### 16.6 Simplicity — not minimalism

Strip the unnecessary so the core purpose shines. Simple ≠ minimal: burying everything in one place looks minimal but isn't simple. Simple designs are frictionless and intuitive — achieved by being *concise* (plain language, no jargon, no redundancy, fewer steps) and *clear* (hierarchy via order, spacing, contrast, so the most important thing is the most obvious).

- Every element earns its place; distill information to its essence — turn complex data into a graphic, summarize so people can focus.
- Sometimes simple means *adding* context: a video scrubber that shows time remaining lets people make informed decisions.
- Answer the user's questions: What do I pay attention to? What can I interact with? How do I interact?
- Show the common path first, advanced options one level deeper.

You know you've arrived when you have *exactly enough*.

### 16.7 Craft — execute flawlessly

Craft is the attention to detail that tells people you care. We all know what a cheap product feels like — a rickety door, a shirt that unravels. In software that's laggy taps, jittery scroll, misaligned icons, layouts that break on rotation: it feels fragile, and people question the quality of the results. Meticulous craft does the opposite — it inspires confidence.

- High-quality materials: type that looks great across devices, colors that adapt to light/dark, clear graphics and iconography, responsive animation that gives immediate, natural feedback, all on reliable and secure foundations.
- Nothing is random — every spacing, timing, and alignment value is a deliberate choice you can defend.
- Craft comes from **iteration** and is a continual process: great design has longevity. Keep evolving it as platforms, hardware, and people's needs change.

When you get the details right, people will know you care.

### 16.8 Delight — the result, not the garnish

Delight is satisfying, enriching, and creates a real emotional connection — and you can't add it at the end. Confetti tacked on top isn't delight. It's the natural result of getting the other seven right: intention, agency, safety, familiar patterns, flexibility, simplicity, and craft, combined into an experience that feels *human*.

- Identify the emotion you want people to feel — relaxed, confident, excited — and find opportunities to reinforce it throughout the design.
- When you give people the agency to act, the safety to explore, the comfort of familiar patterns, and the ability to make it their own, you create something that's a true joy to use.

### Tactics that serve these principles

- **Feedback comes in four kinds** (status, completion, warning, error): confirm meaningful actions, expose ongoing status, warn before problems, validate inline (not on submit). Serves Agency and Responsibility.
- **Wayfinding.** Every screen should answer: Where am I? Where can I go? What's there? How do I get out? Never trap the user. Serves Agency and Familiarity.
- **Grouping & mapping.** Proximity implies relationship; place a control near what it affects and arrange controls to mirror what they change. If you need a label to explain a control, the mapping is weak. Serves Simplicity and Familiarity.
- **Direct, specific labels beat safe generic ones.** Name nav items for their contents ("Progress", "Library"), not vague umbrellas ("Home"). Specificity creates predictability. Serves Familiarity and Simplicity.
